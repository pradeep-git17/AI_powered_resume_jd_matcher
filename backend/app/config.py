...
class Settings(BaseSettings):
    ...
    resume_max_tokens: int = Field(default=180, alias="RESUME_MAX_TOKENS")
    match_max_tokens: int = Field(default=260, alias="MATCH_MAX_TOKENS")
    max_resume_chars: int = Field(default=6000, alias="MAX_RESUME_CHARS")
    max_jd_chars: int = Field(default=3500, alias="MAX_JD_CHARS")
